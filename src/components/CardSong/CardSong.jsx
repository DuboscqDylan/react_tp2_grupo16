...
export const CardSong = ({ song, isFav, onToggle }) => {
  return (
    <NavLink to={`/songs/${song.id}`} className="block">
      <div className="flex items-stretch gap-4 bg-[var(--color-card)] rounded-lg p-3 shadow-sm hover:shadow-md hover:bg-[var(--color-card-hover)] transition-all w-full max-w-md cursor-default">
        ...
        <div className="flex flex-col justify-between flex-shrink-0" style={{ height: "96px" }}>
          <div className="flex-1 flex items-center justify-center relative group">
            <FavoriteButton isFav={isFav} onToggle={onToggle} />
