...
const resources = {
  es: {
    translation: {
      ...
      error: "Error",
      loginRequired: "Por favor, inicia sesión para poder ver tus favoritos.",
      ...
      password:"Contraseña",
      cancel:"Cancelar",
      alreadyHaveAccount:"¿Ya tenés cuenta? Iniciá sesión",
      dontHaveAccount:"¿No tenés cuenta? Registrate",
  ...
  en: {
    translation: {
      ...
      error: "Error",
      loginRequired: "Please log in to see your favorites.",
      login:"Login",
      register:"Register",
      name:"Name",
      email:"Email",
